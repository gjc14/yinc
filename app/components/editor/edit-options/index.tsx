...
const editMarkOptions: EditOptionProps[] = [
	{
		...
		can: (editor: Editor) => editor.can().chain().focus().toggleBold().run(),
	},
	{
		tooltip: 'Italic',
		shortcut: 'Ctrl + I',
		...
		can: (editor: Editor) => editor.can().chain().focus().toggleItalic().run(),
	},
	{
		tooltip: 'Underline',
		shortcut: 'Ctrl + U',
	...
	},
	{
		...
		can: (editor: Editor) => editor.can().chain().focus().toggleStrike().run(),
	},
	{
		tooltip: 'Highlight',
	...
	},
	{
		...
		can: (editor: Editor) => editor.can().chain().focus().toggleCode().run(),
	},
	{
