...
export const LeadershipItem = ({
    ...
    return (
        <div className="mb-6 border-b pb-6 border-muted-foreground">
            <div className="flex flex-col sm:items-center justify-between mb-2 sm:flex-row">
                <Reveal>
                    <>
                        ...
                        <span className="text-secondary font-bold text-sm ml-2 sm:text-base">
                            {title}
                        </span>
                    </>
                </Reveal>
            ...
            <Reveal>
                <ul className="ml-5 text-muted-foreground text-pretty leading-relaxed list-outside list-disc">
